        ...
        <ul class="p-4 pb-24">
            <li class="py-1">
                <NuxtLink
                    to="/dashboard"
                    id="dashboardLink"
                    :class="['mainLink flex gap-3 px-4 py-3 rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929]', { focused: isDashboardMenuActive }]">
            ...
            <li class="py-1">
                <NuxtLink
                    to="/user"
                    id="userLink"
                    :class="['mainLink flex gap-3 px-4 py-3 rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929]', { focused: isUserMenuActive }]">
                    <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <li class="py-1 relative group">
                ...
                <a href="#" id="trainingLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isTrainingMenuActive }]"
                    ...
                    <span class="flex items-center gap-3 text-inherit">
                        <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M7 17.1968H16" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <img src="../../assets/img/down-arrow.png" alt="Arrow"
                ...
                <ul class="subUl bg-[#F9F9F9] px-2 mt-0 space-y-1 max-h-0   overflow-hidden transition-all duration-300 ease-in-out"
                    ...
                    <li>
                        <NuxtLink
                            to="/training/manage"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]"
            ...
            <li class="py-1 relative group">
                ...
                <a href="#" id="studentLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isStudentMenuActive }]"
                    ...
                    <span class="flex items-center gap-3 text-inherit">
                        <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M17.5 11.5L19 13L22 9" stroke="currentColor" stroke-width="2"
            ...
            <li class="py-1 relative group">
                ...
                <a href="#" id="graduateLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isGraduateMenuActive }]"
                    ...
                    <span class="flex items-center gap-3 text-inherit">
                        <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M8.21 14.0088L7 22L12 19.3684L17 22L15.79 14" stroke="currentColor"
            ...
            <!-- <li class="py-1 relative group "> -->
                ...
                <!-- <a href="#" id="licenseLink"
                    class="mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] focus:text-[#2B5BBB] active:text-[#2B5BBB]"
                    onclick="toggleSubMenu(event)">
                    <span class="flex items-center gap-3 text-inherit">
                        <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 11L12 14L21 5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path
                ...
                <!-- <ul
                    ...
                    <li>
                        <a href="license-regist.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">자격등록</a>
                    </li>
                    <li>
                        <a href="license-pay.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">자격입금관리</a>
                    </li>
                    <li>
                        <a href="license-record.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">자격출석부</a>
                    </li>
                    <li>
                        <a href="license-notice.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">합격공지</a>
                    </li>
                    <li>
                        <a href="license-check.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">자격증조회</a>
                    </li>
                </ul>
            </li> -->
                <li class="py-1 relative group ">
                <!-- 관리자 게시판 항목 -->
                <a href="#" id="adminLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isAdminMenuActive }]"
            ...
            <!-- <li class="py-1 relative group "> -->
                <!-- 문자관리 항목 -->
                <!-- <a href="#" id="snsLink"
                    class="mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]"
                    onclick="toggleSubMenu(event)">
                    <span class="flex items-center gap-3 text-inherit">
                        <svg class="subIconSvg stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- <ul
                    ...
                    <li>
                        <a href="sns-group.html"
                            class="block px-8 py-3 rounded-lg text-[#727272] text-sm hover:bg-[#EDF3FF] focus:text-[#1E4799]">문자
                            그룹</a>
                    </li>
                    <li>
            ...
            <li class="py-1 relative group">
                <!-- 설정 항목 -->
                <a href="#" id="siteLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isSiteMenuActive }]"
            ...
            <li class="py-1 relative group mb-10">
                ...
                <a href="#" id="settingLink"
                    :class="['mainLink flex justify-between items-center px-4 py-3 block rounded-lg text-[#727272] hover:bg-[#EDF3FF] hover:text-[#292929] active:text-[#2B5BBB] focus:text-[#2B5BBB]', { focused: isSettingMenuActive }]"
...
<script setup>
    ...
    const isUserMenuActive = computed(() => {
        if (activeMenuId.value) {
            return activeMenuId.value === 'user';
        }
